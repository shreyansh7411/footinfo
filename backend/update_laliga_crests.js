...
const teamCrestMapping = {
  ...
  'Sporting Gijón': '/Spain - LaLiga/Sporting Gijón.png',
  'Sporting de Gijón': '/Spain - LaLiga/Sporting Gijón.png'
};
...
const urlReplacements = [
  ...
  { old: 'https://upload.wikimedia.org/wikipedia/en/3/3f/Real_Betis_logo.svg', new: '/Spain - LaLiga/Real Betis Balompié.png' },
  ...
  // Getafe
  { old: 'https://upload.wikimedia.org/wikipedia/en/8/86/Getafe_CF_logo.svg', new: '/Spain - LaLiga/Getafe CF.png' },
  { old: 'https://upload.wikimedia.org/wikipedia/en/6/6f/Getafe_CF_logo.svg', new: '/Spain - LaLiga/Getafe CF.png' },

  // Sporting Gijón
  { old: 'https://upload.wikimedia.org/wikipedia/en/6/6e/Sporting_de_Gij%C3%B3n_logo.svg', new: '/Spain - LaLiga/Sporting Gijón.png' },

  // Levante
  { old: 'https://upload.wikimedia.org/wikipedia/en/5/51/Levante_Uni%C3%B1%C3%B3n_LOGO.svg', new: '/Spain - LaLiga/Levante UD.png' }
];
